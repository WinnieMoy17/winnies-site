const Hero = () => {
  return (
    <section
      id="hero"
      className="pt-60 pb-36 flex items-center justify-center"
    >
      <div className="flex flex-col items-start justify-center text-left max-w-3xl px-4">
        <h1 className="text-5xl mb-5 leading-tight bg-gradient-to-r from-black to-pink-600 bg-clip-text text-transparent">
