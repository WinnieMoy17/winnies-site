        ...
        <section
            ...
            <div>
                ...
                <div className="flex justify-between gap-10 mx-5">
                    <div className="w-1/2 flex flex-col text-[24px] mt-10 gap-10">
                        <p>Heyyy! Welcome!</p>
                    ...
                    <div className="w-1/2 mt-[650px]">
                        <h2 className="text-5xl mb-5">&#128187; &nbsp;tech stack.</h2>
                        <div className="flex flex-wrap gap-7 mb-24 text-2xl">
                            {techStack.map((tech) => (
                                <p key={tech}>{tech}</p>
                            ))}
                        </div>
                        <h2 className="text-5xl mb-5">&#127912; &nbsp;design tools.</h2>
